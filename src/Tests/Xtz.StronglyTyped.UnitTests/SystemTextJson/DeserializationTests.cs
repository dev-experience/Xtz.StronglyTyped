...
namespace Xtz.StronglyTyped.UnitTests.SystemTextJson
{
    public class DeserializationTests
    {
        ...
        public void ShouldDeserialize_ToStronglyTypedStringClass(string value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedString>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedStringStruct(string value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedStringStruct>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedStringClassAllowEmpty(string value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedStringAllowEmpty>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedStringStructAllowEmpty(string value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedStringAllowEmptyStruct>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedGuidClass(Guid value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedGuid>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedGuidStruct(Guid value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedGuidStruct>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedGuidIdClass(Guid value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedGuidId>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedIntClass(int value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedInt>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedIntStruct(int value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedIntStruct>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedIntIdClass(int value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedIntId>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedBoolClass()
        {
            ...
            var result = JsonSerializer.Deserialize<IReadOnlyCollection<SerializationDto<StronglyTypedBool>>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedByteClass(byte value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedByte>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedCharClass(char value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedChar>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedCharClass(char value, string serializedValue)
        {
            // Arrange

            var stronglyTyped = new SerializationDto<StronglyTypedChar>(value);
            var json = BuildString(serializedValue);
        ...
        public void ShouldDeserialize_ToStronglyTypedDecimalClass(decimal value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedDecimal>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedDecimalClass()
        {
            ...
            var result = JsonSerializer.Deserialize<IReadOnlyCollection<SerializationDto<StronglyTypedDecimal>>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedDoubleClass(double value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedDouble>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedFloatClass(float value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedFloat>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedLongClass(long value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedLong>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedSbyteClass(sbyte value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedSbyte>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedShortClass(short value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedShort>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedUintClass(uint value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedUint>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedUlongClass(ulong value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedUlong>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedUshortClass()
        {
            ...
            var result = JsonSerializer.Deserialize<IReadOnlyCollection<SerializationDto<StronglyTypedUshort>>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedDateTimeClass(DateTime value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedDateTime>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedTimeSpanClass_FromTicks(long value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<StronglyTypedTimeSpan>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedEmailClass(Email value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<Email>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedEmailsClass(IReadOnlyCollection<Email> values)
        {
            ...
            var result = JsonSerializer.Deserialize<IReadOnlyCollection<SerializationDto<Email>>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedIpV4AddressClass(IpV4Address value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<IpV4Address>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedIpV6AddressClass(IpV6Address value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<IpV6Address>>(json, JSON_SERIALIZER_SETTINGS);
        ...
        public void ShouldDeserialize_ToStronglyTypedMacAddressClass(MacAddress value)
        {
            ...
            var result = JsonSerializer.Deserialize<SerializationDto<MacAddress>>(json, JSON_SERIALIZER_SETTINGS);
